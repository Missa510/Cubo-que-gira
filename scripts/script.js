...
if (CheckWebGLCompatibilidad()) {
    ...
    function Iniciar() {
        ...
        const puntos = []
        const escala = 1.45, escala_cubo = 1.02, radio_esfera = 4, segmentos_esfera = 20, altura_segmentos = 15
        ...
        const luz1 = new THREE.DirectionalLight(new THREE.Color(lucesAlAzar()), 1)
        const luz2 = new THREE.DirectionalLight(new THREE.Color(lucesAlAzar()), 1)
        const luz3 = new THREE.DirectionalLight(new THREE.Color(lucesAlAzar()), 1)
